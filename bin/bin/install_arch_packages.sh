sudo pacman -S zsh-autosuggestions zsh-syntax-highlighting base-devel terminus-font powerline-fonts neofetch 

sudo pacman -S wl-clipboard xclip clipmenu 

sudo pacman -S emacs nvim python-pip python-pynvim hunspell-en_us hunspell-de 
