...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-alert ess-smart-underscore ess doom-modeline evil-magit magit counsel flycheck outshine volatile-highlights tex-site evil-matchit company-reftex elpy latex-pretty-symbols projectile dashboard page-break-lines auctex-latexmk which-key smartparens-config yasnippet use-package smartparens pretty-mode org-bullets nord-theme evil-leader evil-commentary company auctex))))
(custom-set-faces
